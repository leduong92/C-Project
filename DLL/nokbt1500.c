...
//-----------------------------------------------------------------------------
//	関数名：int StartDisplay(char *title,char *l1,char *l2,char *l3,char *l4,char *g1,char *2,char *3)
//	機能　：起動直後の初期画面(DT-950のMain.cの画面に相当)
//	戻り値：キーコード
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//	関数名：void LineOut2( char* dat, short lineNo,short reverse)
//	機能　：画面表示（表示only）
//	引数１：
//		＊表示可能な文字数は、１行あたり20バイトです。
//		縦のみ２倍角表示
//-----------------------------------------------------------------------------
