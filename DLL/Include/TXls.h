...
//				2006.08.31 coba 「縮小して全体表示」PutFit()を追加
//				2007.03.08 ﾏﾂﾀﾞ インクルードライブラリをVer3用に変更
//				2007.03.08 ﾏﾂﾀﾞ シートのコピー機能を追加 エクセルクリエータ3以上の関数
//				2007.06.06 Y.Kogai 行・列の操作追加
//				2008.09.22 coba セル幅をdoubleで指定する関数を追加
//				2008.12.11 coba 印刷範囲の設定 SetPrnArea()を追加
//				2009.02.05 ﾏﾂﾀﾞ アクティブなシートを切り替える関数SetActiveSheetを追加
//				2010.12.23 ﾏﾂﾀﾞ ﾋﾞｭｰﾜ関数を使って画面なしで印刷する関数を追加 XlsViewPrint
//				2013.04.18 coba フォントスタイル設定SetFontStyle()追加
//------------------------------------------------------------------------------------------------
