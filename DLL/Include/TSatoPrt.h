...
//              2005. 5.10 プチラパン(PT-200e)用の漢字出力関数追加
//				2014.09.15 DrawKanji,DrawKanjiPTで半角カナの場合に印字できない不具合を修正
//				2015.01.26 印刷時にセンサ位置を無視するかどうかの設定を追加
//=====================================================================================================================
...
class TSatoPrinter
{
	public:
		...
		int StartLabel(int mode, char speed, BOOL ignore_sensor=FALSE);	//センサ位置を無視するかどうかの設定を追加	//2015.01.26 sanno
		//int StartLabel(int mode, char speed);
		int EndLabel(long page, BOOL ignore_sensor=FALSE);	////センサ位置を無視するかどうかの設定を追加	//2015.01.26 sanno
