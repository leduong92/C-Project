...
//	＊前に設定されていた文字列は破棄されます
//========================================================================================================
int TString::operator =(TString& ts)
{
	// リセット
	Destroy();
...
//	＊前に設定されていた文字列は破棄されます
//========================================================================================================
int TString::operator =(const char* str)
{
	// リセット
	Destroy();
...
//	＊前に設定されていた文字列は破棄されます
//========================================================================================================
int TString::operator =(const char a)
{
	char str[2];
...
//	＊前に設定されていた文字列は破棄されます
//========================================================================================================
int TString::operator =(unsigned char a)
{
	char str[2];
...
//	＊前に設定されていた文字列は破棄されます
//========================================================================================================
int TString::operator =(unsigned char* str)
{
	// リセット
	Destroy();
